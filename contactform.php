...
<head>
    ...
    <link rel="stylesheet" href="RadioRashiCSS/form.css">
    <link rel="stylesheet" href="RadioRashiCSS/formMedia.css">
...
<body>
    <div class="obuspinchl">
        <div class="usp">
            <div class=obdiv>
                <div class="nchldiv">
                    <a class="nchl" href="rashi page 4.php">Към началната страница</a>
                </div>
